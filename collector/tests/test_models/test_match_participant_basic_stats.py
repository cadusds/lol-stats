...
class MatchParticipantBasicStatsTestCase(TestCase):
    ...
    def test_create_match_participant_basic_stats_object_with_match_data(self, mocked):
        ...
        (
            _,
            created,
        ) = self.model.objects.create_match_participant_basic_stats_object_with_match_data(
