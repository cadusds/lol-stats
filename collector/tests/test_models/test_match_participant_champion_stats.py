...
from collector.models import MatchParticipantChampionStats
from ..factories.summoner import SummonerFactory
from ..factories.match import MatchFactory


class MatchParticipantChampionStatsTestCase(TestCase):
    def setUp(self) -> None:
        self.maxDiff = None
        self.lol_api = LeagueOfLegendsAPI()
        self.model = MatchParticipantChampionStats
    ...
    def test_create_match_participant_champion_stats_object_with_match_data(
        ...
        (
            _,
            created,
        ) = self.model.objects.create_match_participant_champion_stats_object_with_match_data(
